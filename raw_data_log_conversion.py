...
"""
This script is used to check the ranges of both the qualities to be learned,
i.e. mean and standard deviation of tree height and crown radius, and the
predictors. If an observable's range spans multiple orders of magnitude its
values are logarithmized via the natural logarithm so that the bins used for the
learning process are in the logarithmic space.
"""
